...
const routes = [
    ...
    {
        path: '',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-colors-colors-colors-module */ "pages-colors-colors-colors-module").then(__webpack_require__.bind(null, /*! ./pages/colors/colors/colors.module */ "./src/app/pages/colors/colors/colors.module.ts")).then(m => m.ColorsModule),
    },
    {
        path: 'colors',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-colors-colors-colors-module */ "pages-colors-colors-colors-module").then(__webpack_require__.bind(null, /*! ./pages/colors/colors/colors.module */ "./src/app/pages/colors/colors/colors.module.ts")).then(m => m.ColorsModule),
...
AppComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: AppComponent, selectors: [["app-root"]], decls: 8, vars: 0, consts: [[1, "fluid-container"], [1, "header", "p-3"], [1, "container", "d-flex", "justify-content-between", "align-items-center"], [1, "brand"], [1, "sub-title-1"]], template: function AppComponent_Template(rf, ctx) { if (rf & 1) {
...
module.exports = __webpack_require__(/*! C:\Users\Norte Front\Documents\cesar\codigo\mx-colors\src\main.ts */"./src/main.ts");
